                            ...
                            <div class="detail">
                                ...
                                <div class="etat">
                                    ...
                                    ?>
                                            ...
                                            <input class="input form-control" type="text" placeholder="motif de rejet" name="motif_rejet" id="motif_rejet<?= $demande['id_demande']; ?>">
            ...
            if ((statut == 'Admin') && (etat == 'en attente')) {
                ...
                refuser<?= $demande['id_demande']; ?>.addEventListener('click', function() {
                    if (motifRejet<?= $demande['id_demande']; ?>.value === "") {
                        console.log('motif non rempli');
                        event.preventDefault();
                        alert('Veuillez remplir le motif de rejet.');
                    } else {
                        console.log('motif rempli');
